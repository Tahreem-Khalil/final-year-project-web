                        ...
                        <div class="white-box">
                            <form class="form-horizontal form-material">
                                <div class="form-group">
                                    <label class="col-md-12">Vaccine Type</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="Enter Vaccine Type" class="form-control form-control-line" name="vaccineType" required> </div>
                                </div>
                                <div class="form-group">
                                    <label  class="col-md-12">Vaccine Amount</label>
                                    <div class="col-md-12">
                                        <input type="number" placeholder="Enter Vaccine Amount" class="form-control form-control-line" name="example-email" name="vaccineAmount" required> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Health Worker CINC</label>
                                    <div class="col-md-12">
                                        <input type="number" placeholder="Enter 13 digit CNIC" class="form-control form-control-line" name="healthWorkerCnic" required></div>
                                </div>
                                  <div class="form-group">
                                    <label class="col-md-12">Health Coordinator CINC</label>
                                    <div class="col-md-12">
                                        <input type="number" placeholder="Enter 13 digit CNIC" class="form-control form-control-line" name="healthCoordinatorCnic" required></div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <button class="btn btn-success" name="addVaccineButton">Add Vaccines</button>
                                    </div>
                                </div>
                            </form>
                        </div>
