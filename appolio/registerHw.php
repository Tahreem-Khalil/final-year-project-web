...
<head>
    ...
    <title>Register Health Worker</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Register Health Worker</h4> </div>
                </div>
                <!-- /.row -->
                <!-- .row -->
                <div class="row">
                    <div class="col-md-12 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material" action="registerHealthWorkerInsert.php" method="post">
                               <div class="form-group">
                                    <label class="col-md-12">CINC</label>
                                    <div class="col-md-12">
                                        <input type="number" name="health_worker_CNIC"  placeholder="3710198738984" class="form-control form-control-line" required> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Full Name</label>
                                    <div class="col-md-12">
                                        <input type="text" name="Health_Worker_Name" placeholder="Name" class="form-control form-control-line" required> </div>
                                </div>
                                <div class="form-group">
                                    <label for="example-email" class="col-md-12">Email</label>
                                    <div class="col-md-12">
                                        <input type="email" placeholder="Email" name="health_worker_email" class="form-control form-control-line" name="example-email" id="example-email" required> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Password</label>
                                    <div class="col-md-12">
                                        <input type="password" name="health_worker_password" placeholder="password" class="form-control form-control-line" required> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Phone No</label>
                                    <div class="col-md-12">
                                        <input type="text" name="Health_Worker_Phone_no" placeholder="02462274489" class="form-control form-control-line" required> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">EPI Center</label>
                                    <div class="col-md-12">
                                        <input type="text" name="EPI_Center" placeholder="dhq attock" class="form-control form-control-line" required> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Gender</label>
                                    <div class="col-md-12">
                                        <input type="text" name="health_worker_gender" placeholder="male/female" class="form-control form-control-line" required> </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-4">
                                        <button name="RegisterButton" class="btn btn-success">Register Health worker</button>
                                    </div>
                                    <div class="col-sm-4">
                                        <button name="UpdateButton" class="btn btn-success">Update Health worker</button>
                                    </div>
                                    <div class="col-sm-4">
                                        <button name="DeleteButton" class="btn btn-success">Delete Health worker</button>
                                    </div>
                                </div>
                            </form>
                        </div>
